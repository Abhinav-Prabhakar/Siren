...
/**
 * Full personnel deck — extracted from the old /people page for the
 ...
 * is preserved: status matrix, role breakdown, filters, roster grid,
 * command panel, vitals watch, detail modal.
 */
export function PersonnelDeck() {
