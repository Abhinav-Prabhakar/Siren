    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      >
        <div className="clip-chamfer m-px bg-coal [--chamfer:19px]">
          {title !== undefined && (
            <header className="flex items-center gap-2.5 border-b border-flame/15 px-5 py-3">
              <Led tone={led} pulse={led === "flame"} />
              <h2 className="font-display text-xs font-bold uppercase tracking-[0.25em] text-bone">
                {title}
              </h2>
            </header>
          )}
